...
[extra,a9__,a9_]=plotyy(TT2_treat,prev_PWID_scen1,TT2_treat,prev_PWID_scen1); 
set(a9_,'Color','k','LineStyle','--','Linewidth',2); set(a9__,'visible','off');
set(extra(2), 'XTick',[],'xlim',[50,80],'ylim',[0,60],'YTick',0:10:60,'ycolor','k','FontSize',12);
set(extra(1), 'xlim',[0,80],'ylim',[0,250000],'XTick',0:10:100,'XTickLabel',1950:10:2050,'FontSize',12,'YTick',0:50000:250000,'YTickLabel',0:50:250,'ycolor','k');
set(get(extra(2),'Ylabel'),'String','Prevalence among PWID (%)','fontsize',14);
%legpatch=findobj(leg,'type','patch'); hatchfill(legpatch,'single',45,1,'blue');
...
% base=[sum(sum(ycomb_noage(:,1,:,1:5),3),4),sum(ycomb_noage(:,1,:,6),3),sum(sum(ycomb_noage(:,1,:,7:11),3),4),reshape(sum(ycomb_noage(:,1,:,12:18),3),length(ycomb_noage(:,1,1,1)),7),sum(sum(ycomb_noage(:,1,:,19:20),3),4)]*total_PWID./repmat(sum(sum(ycomb_noage(:,1,:,1:20),3),4),1,11)...
%     +[sum(sum(sum(ycomb_noage(:,2:3,:,1:5),2),3),4),sum(sum(ycomb_noage(:,2:3,:,6),2),3),sum(sum(sum(ycomb_noage(:,2:3,:,7:11),2),3),4),reshape(sum(sum(ycomb_noage(:,2:3,:,12:18),2),3),length(ycomb_noage(:,1,1,1)),7),sum(sum(sum(ycomb_noage(:,2:3,:,19:20),2),3),4)]*(total_HCV-total_PWID*prev0)./sum(sum(sum(ycomb_noage(t_val(1),2:3,:,[12:20]),2),3),4);
% scen1=[sum(sum(ycomb2_noage(:,1,:,1:5),3),4),sum(ycomb2_noage(:,1,:,6),3),sum(sum(ycomb2_noage(:,1,:,7:11),3),4),reshape(sum(ycomb2_noage(:,1,:,12:18),3),length(ycomb2_noage(:,1,1,1)),7),sum(sum(ycomb2_noage(:,1,:,19:20),3),4)]*total_PWID./repmat(sum(sum(ycomb2_noage(:,1,:,1:20),3),4),1,11)...
%     +[sum(sum(sum(ycomb2_noage(:,2:3,:,1:5),2),3),4),sum(sum(ycomb2_noage(:,2:3,:,6),2),3),sum(sum(sum(ycomb2_noage(:,2:3,:,7:11),2),3),4),reshape(sum(sum(ycomb2_noage(:,2:3,:,12:18),2),3),length(ycomb2_noage(:,1,1,1)),7),sum(sum(sum(ycomb2_noage(:,2:3,:,19:20),2),3),4)]*(total_HCV-total_PWID*prev0)./sum(sum(sum(ycomb2_noage(t_val(1),2:3,:,[12:20]),2),3),4);
% scen2=[sum(sum(ycomb2_noage(:,1,:,1:5),3),4),sum(ycomb2_noage(:,1,:,6),3),sum(sum(ycomb2_noage(:,1,:,7:11),3),4),reshape(sum(ycomb2_noage(:,1,:,12:18),3),length(ycomb2_noage(:,1,1,1)),7),sum(sum(ycomb2_noage(:,1,:,19:20),3),4)]*total_PWID./repmat(sum(sum(ycomb2_noage(:,1,:,1:20),3),4),1,11)...
%     +[sum(sum(sum(ycomb2_noage(:,2:3,:,1:5),2),3),4),sum(sum(ycomb2_noage(:,2:3,:,6),2),3),sum(sum(sum(ycomb2_noage(:,2:3,:,7:11),2),3),4),reshape(sum(sum(ycomb2_noage(:,2:3,:,12:18),2),3),length(ycomb2_noage(:,1,1,1)),7),sum(sum(sum(ycomb2_noage(:,2:3,:,19:20),2),3),4)]*(total_HCV-total_PWID*prev0)./sum(sum(sum(ycomb2_noage(t_val(1),2:3,:,[12:20]),2),3),4);
% scen3=[sum(sum(ycomb2_noage(:,1,:,1:5),3),4),sum(ycomb2_noage(:,1,:,6),3),sum(sum(ycomb2_noage(:,1,:,7:11),3),4),reshape(sum(ycomb2_noage(:,1,:,12:18),3),length(ycomb2_noage(:,1,1,1)),7),sum(sum(ycomb2_noage(:,1,:,19:20),3),4)]*total_PWID./repmat(sum(sum(ycomb2_noage(:,1,:,1:20),3),4),1,11)...
%     +[sum(sum(sum(ycomb2_noage(:,2:3,:,1:5),2),3),4),sum(sum(ycomb2_noage(:,2:3,:,6),2),3),sum(sum(sum(ycomb2_noage(:,2:3,:,7:11),2),3),4),reshape(sum(sum(ycomb2_noage(:,2:3,:,12:18),2),3),length(ycomb2_noage(:,1,1,1)),7),sum(sum(sum(ycomb2_noage(:,2:3,:,19:20),2),3),4)]*(total_HCV-total_PWID*prev0)./sum(sum(sum(ycomb2_noage(t_val(1),2:3,:,[12:20]),2),3),4);
% scen4=[sum(sum(ycomb2_noage(:,1,:,1:5),3),4),sum(ycomb2_noage(:,1,:,6),3),sum(sum(ycomb2_noage(:,1,:,7:11),3),4),reshape(sum(ycomb2_noage(:,1,:,12:18),3),length(ycomb2_noage(:,1,1,1)),7),sum(sum(ycomb2_noage(:,1,:,19:20),3),4)]*total_PWID./repmat(sum(sum(ycomb2_noage(:,1,:,1:20),3),4),1,11)...
%     +[sum(sum(sum(ycomb2_noage(:,2:3,:,1:5),2),3),4),sum(sum(ycomb2_noage(:,2:3,:,6),2),3),sum(sum(sum(ycomb2_noage(:,2:3,:,7:11),2),3),4),reshape(sum(sum(ycomb2_noage(:,2:3,:,12:18),2),3),length(ycomb2_noage(:,1,1,1)),7),sum(sum(sum(ycomb2_noage(:,2:3,:,19:20),2),3),4)]*(total_HCV-total_PWID*prev0)./sum(sum(sum(ycomb2_noage(t_val(1),2:3,:,[12:20]),2),3),4);
% 
