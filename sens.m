...
sens_table = [Table_base([1,13:22],:);...
    Table_lowercov([1,13:22],:);...
    Table_highercov([1,13:22],:);...
    Table_highersensitivity([1,13:22],:);...
    Table_annualtest([1,13:22],:);...
    Table_90diagnosedtreated([1,13:22],:);...
    Table_GPscreening([1,13:22],:)];
