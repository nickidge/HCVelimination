...
paper2 = [round([diag_test(23,2,2,1), diag_serum(23,2,2,1), diag_DBS(23,2,2,1)],0);...
     ...
     round([summary_test(2,2,1,5,1), summary_serum(2,2,1,5,1), summary_DBS(2,2,1,5,1)],0);... % incidence in 2030
     round([summary_test(2,2,1,8,1), summary_serum(2,2,1,8,1), summary_DBS(2,2,1,8,1)],0);... % prevalence in 2030
     round(100*(inc2017 - [summary_test(2,2,1,5,1), summary_serum(2,2,1,5,1), summary_DBS(2,2,1,5,1)])/inc2017,0);... % incidence reduction in 2030
     round(100*(death2017 - [summary_test(2,2,1,6,1), summary_serum(2,2,1,6,1), summary_DBS(2,2,1,6,1)])/death2017,0)]; % mortality reduction in 2030
     
     
paper2_text = zeros(length(paper2(:,1))+1,1+length(paper2(1,:)));
paper2_text = num2cell(paper2_text);
paper2_text{1,1} = 'Scenario';
paper2_text{1,2} = 'Ab+RNA';
paper2_text{1,3} = 'Serum-based HCVcAg';
paper2_text{1,4} = 'Dry Blood Spot HCVcAg';
...
paper2_text{6,1} = 'Incidence in 2030';
paper2_text{7,1} = 'Prevalence in 2030';
paper2_text{8,1} = 'Incidence reduction in 2030';
paper2_text{9,1} = 'Prevalence reduction in 2030';
paper2_text{10,1} = 'Mortality reduction in 2030';
