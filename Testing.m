...
>>>>>>> 0d03dc0e295ebda5ab2d6d1f36acf2a7b3b4cd45
...
for s=1:sens
 ...
 %% Run model in prior to 2017
    ...
    for h = 1:length(harm_reduction_range)
        ...
        %y2comb_noage=reshape(sum(sum(sum(sum(y2comb,4),5),6),7),size(y2comb,1),num_pops, num_cascade,27+6); %Reshape to sum over age stratification
